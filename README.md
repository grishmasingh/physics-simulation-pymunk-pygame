# Physics-simulation-pymunk-pygame
...
I decided to create this project because not only am I currently learning Python, but I also introduced my friends to Anime and they themselves were not sure on where to start so I decided - "Hey, Why not put my Python skills into a real-case use" :bulb:
...
Nevertheless, I hope whoever may use and/or see this, please feel free to use my code as I wrote comments to guide ! :open_hands:
